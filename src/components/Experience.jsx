...
const Experience = () => {
  ...
  return (
    <section className='px-6 py-10' id='experience'>
        <h1 className='text-4xl md:text-6xl font-semibold tracking-tight mb-10 text-center'>Work Experience</h1>
            ...
            {EXPERIENCES.map((experience, index) => (
                <motion.div key={index} variants={childVariants}>
                    <div className='flex flex-col md:flex-row md:justify-between'>
                        ...
                        <div className='max-w-3xl backdrop:blur-3xl p-4 bg-stone-600/10 rounded-l-lg'>
